...
/* harmony import */ var _payment_payment_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./payment/payment.component */ "./src/app/payment/payment.component.ts");
/* harmony import */ var _payment_payment_list_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./payment/payment-list.component */ "./src/app/payment/payment-list.component.ts");
/* harmony import */ var _client_client_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./client/client.component */ "./src/app/client/client.component.ts");
/* harmony import */ var _client_client_list_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./client/client-list.component */ "./src/app/client/client-list.component.ts");
/* harmony import */ var _inventory_inventory_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./inventory/inventory.component */ "./src/app/inventory/inventory.component.ts");
/* harmony import */ var _inventory_inventory_list_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./inventory/inventory-list.component */ "./src/app/inventory/inventory-list.component.ts");
/* harmony import */ var _order_order_component__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./order/order.component */ "./src/app/order/order.component.ts");
/* harmony import */ var _order_order_list_component__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./order/order-list.component */ "./src/app/order/order-list.component.ts");
...
var routes = [
    ...
    {
        path: 'payment',
        component: _payment_payment_component__WEBPACK_IMPORTED_MODULE_34__["PaymentComponent"]
    },
    {
        path: 'paymentlist',
        component: _payment_payment_list_component__WEBPACK_IMPORTED_MODULE_35__["PaymentListComponent"]
    },
    {
        path: 'payment/:id',
        component: _payment_payment_component__WEBPACK_IMPORTED_MODULE_34__["PaymentComponent"]
    ...
    {
        path: 'client',
        component: _client_client_component__WEBPACK_IMPORTED_MODULE_36__["ClientComponent"]
    },
    {
        path: 'clientlist',
        component: _client_client_list_component__WEBPACK_IMPORTED_MODULE_37__["ClientListComponent"]
    },
    {
        path: 'client/:id',
        component: _client_client_component__WEBPACK_IMPORTED_MODULE_36__["ClientComponent"]
    ...
    {
        path: 'inventory',
        component: _inventory_inventory_component__WEBPACK_IMPORTED_MODULE_38__["InventoryComponent"]
    },
    {
        path: 'inventory/:id',
        component: _inventory_inventory_component__WEBPACK_IMPORTED_MODULE_38__["InventoryComponent"]
    ...
    {
        path: 'inventorylist',
        component: _inventory_inventory_list_component__WEBPACK_IMPORTED_MODULE_39__["InventoryListComponent"]
    },
    {
        path: 'order',
        component: _order_order_component__WEBPACK_IMPORTED_MODULE_40__["OrderComponent"]
    },
    {
        path: 'order/:id',
        component: _order_order_component__WEBPACK_IMPORTED_MODULE_40__["OrderComponent"]
    ...
    {
        path: 'orderlist',
        component: _order_order_list_component__WEBPACK_IMPORTED_MODULE_41__["OrderListComponent"]
    },
];
...
/* harmony import */ var _payment_payment_list_component__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! ./payment/payment-list.component */ "./src/app/payment/payment-list.component.ts");
/* harmony import */ var _client_client_list_component__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! ./client/client-list.component */ "./src/app/client/client-list.component.ts");
/* harmony import */ var _client_client_component__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(/*! ./client/client.component */ "./src/app/client/client.component.ts");
/* harmony import */ var _inventory_inventory_component__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(/*! ./inventory/inventory.component */ "./src/app/inventory/inventory.component.ts");
/* harmony import */ var _inventory_inventory_list_component__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(/*! ./inventory/inventory-list.component */ "./src/app/inventory/inventory-list.component.ts");
...
/* harmony import */ var _order_order_list_component__WEBPACK_IMPORTED_MODULE_53__ = __webpack_require__(/*! ./order/order-list.component */ "./src/app/order/order-list.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _payment_payment_list_component__WEBPACK_IMPORTED_MODULE_47__["PaymentListComponent"],
                _client_client_list_component__WEBPACK_IMPORTED_MODULE_48__["ClientListComponent"],
                _client_client_component__WEBPACK_IMPORTED_MODULE_49__["ClientComponent"],
                _inventory_inventory_component__WEBPACK_IMPORTED_MODULE_50__["InventoryComponent"],
                _inventory_inventory_list_component__WEBPACK_IMPORTED_MODULE_51__["InventoryListComponent"],
                _order_order_component__WEBPACK_IMPORTED_MODULE_52__["OrderComponent"],
                _order_order_list_component__WEBPACK_IMPORTED_MODULE_53__["OrderListComponent"],
            ],
            imports: [
...
/***/ "./src/app/client/client-list.component.html":
/*!***************************************************!*\
  !*** ./src/app/client/client-list.component.html ***!
  \***************************************************/
/*! no static exports found */
...
var ClientListComponent = /** @class */ (function (_super) {
    ...
    ClientListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./client-list.component.html */ "./src/app/client/client-list.component.html"),
        }),
...
var ClientComponent = /** @class */ (function (_super) {
    ...
    function ClientComponent(locator, route, httpClient) {
        var _this = _super.call(this, locator.endpoints.CLIENT, locator, route) || this;
        _this.locator = locator;
        _this.route = route;
        _this.httpClient = httpClient;
    ...
    ClientComponent.prototype.test = function () {
    };
...
/***/ "./src/app/inventory/inventory-list.component.html":
/*!*********************************************************!*\
  !*** ./src/app/inventory/inventory-list.component.html ***!
  \*********************************************************/
/*! no static exports found */
...
var InventoryListComponent = /** @class */ (function (_super) {
    ...
    function InventoryListComponent(locator, route, httpClient) {
        ...
        _this.isValidSupplierNameInput = true;
        _this.isValidQuantityInput = true;
        return _this;
    }
    ...
    InventoryListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./inventory-list.component.html */ "./src/app/inventory/inventory-list.component.html"),
        }),
...
module.exports = "<app-navbar></app-navbar>\n<style>\n  .grad {\n    background-image: linear-gradient(to bottom right, rgb(32, 168, 168), rgb(219, 231, 237));\n    background-repeat: no repeat;\n    background-size: 100%;\n    padding-bottom: 25px;\n  }\n</style>\n\n<style type=\"text/css\">\n  .log1 {\n    padding-top: 13%;\n  }\n\n  .input-group-addon {\n    box-shadow: 9px 8px 7px #001a33;\n\n  }\n</style>\n\n<div class=\"row \" style=\"padding-top: 2%; padding-bottom:2%;\n\nbackground: url(assets/files/wall.jpg) no-repeat center center;\nbackground-attachment: fixed;\nbackground-size: cover;width:100%;\n  height: auto;\">\n\n  <div class=\"col-sm-4\"></div>\n  <div class=\"col-sm-4\">\n    <div class=\"card\">\n      <div class=\"card-body input-group-addon grad \">\n        <form name=\"userForm\">\n          <h2 *ngIf=\"!form.data.id>0\" class=\"text-primary font-weight-bold\" style=\"text-align: center;\">{{'Add Inventory' |\n            translate }}</h2>\n          <h2 *ngIf=\"form.data.id>0\" class=\"text-primary font-weight-bold\" style=\"text-align: center;\">{{'Update Inventory' |\n            translate }}</h2>\n\n\n          <div *ngIf=\"!form.error && form.message != null\" class=\"alert alert-success alert-dismissible\">\n            <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\n            {{form.message}}\n          </div>\n\n          <div *ngIf=\"form.error && form.message != null\" class=\"alert alert-danger alert-dismissible\">\n            <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\n            {{form.message}}\n          </div>\n\n          \n        <div>\n            <span class=\"pt-2\"><b>{{'Supplier Name' | translate }}</b>\n              <span class=\"required-field\"></span></span>\n            <div class=\"col-sm-12\">\n              <div class=\"input-group\">\n                <div class=\"input-group-prepend\">\n                  <div class=\"input-group-text\"><i class=\"fa fa-user-circle grey-text\"></i> </div>\n                </div>\n                <input type=\"text\" name=\"supplierName\" [(ngModel)]=\"form.data.supplierName\" class=\"form-control\"\n                  placeholder=\"{{'Enter Supplier Name'  | translate }}\">\n              </div>\n           </div>\n           <!-- <span *ngIf=\"form.inputerror.accountholdername != null\" class=\"alertRedColor\" style=\" color: red;\">\n              {{'accountholdername'| translate}} </span>  -->\n            <span class=\"alertRedColor\" style=\"color: red;\"> {{form.inputerror.supplierName}} </span>\n          </div>\n\n          <div>\n            <span class=\"pt-2\"><b>{{'Last Update Date' | translate }}</b>\n              <span class=\"required-field\"></span></span>\n\n            <div class=\"col-sm-12\">\n              <div class=\"input-group\">\n                <div class=\"input-group-prepend\">\n                  <div class=\"input-group-text\"><i class=\"fa fa-user grey-text\"></i> </div>\n                </div>\n                <div *ngIf=\"form.data.lastUpdateDate\">\n                  <input type=\"text\" name=\"lastUpdateDate\" [(ngModel)]=\"form.data.lastUpdateDate\" class=\"form-control\"\n                         placeholder=\"{{ 'Enter Last Update Date' | translate }}\">\n                </div>\n                <div *ngIf=\"!form.data.lastUpdateDate\">\n                  <input type=\"date\" name=\"lastUpdateDate\" [(ngModel)]=\"form.data.lastUpdateDate\" class=\"form-control\"\n                         placeholder=\"{{ 'Enter Last Update Date' | translate }}\">\n                </div>\n                \n              </div>\n            </div>\n            <!-- <span *ngIf=\"form.inputerror.accountNo != null\" class=\"alertRedColor\" style=\" color: red;\">\n              {{'accountNo'| translate}} </span> -->\n           <span class=\"alertRedColor\" style=\" color: red;\"> {{form.inputerror.lastUpdateDate}} </span>\n          </div>\n\n          <div>\n            <span class=\"pt-2\"><b>{{'Quantity' | translate }}</b>\n              <span class=\"required-field\"></span></span>\n\n            <div class=\"col-sm-12\">\n              <div class=\"input-group\">\n                <div class=\"input-group-prepend\">\n                  <div class=\"input-group-text\"><i class=\"fa fa-envelope grey-text\"></i> </div>\n                </div>\n                <input type=\"text\" name=\"quantity\" [(ngModel)]=\"form.data.quantity\" class=\"form-control\"\n                  placeholder=\"{{'Enter Quantity'  | translate }}\">\n              </div>\n            </div>\n            <!-- <span *ngIf=\"form.inputerror.branch!= null\" class=\"alertRedColor\" style=\" color: red;\"> {{'branch'|\n              translate}} </span> -->\n             <span class=\"alertRedColor\" style=\" color: red;\"> {{form.inputerror.quantity}} </span> \n          </div>\n\n          <div>\n            <span class=\"pt-2\"><b>{{'Product' | translate }}</b>\n              <span class=\"required-field\"></span></span>\n\n            <div class=\"col-sm-12\">\n              <div class=\"input-group\">\n                <div class=\"input-group-prepend\">\n                  <div class=\"input-group-text\"><i class=\"fa fa-key grey-text\"></i> </div>\n                </div>\n                <input type=\"text\" name=\"product\" [(ngModel)]=\"form.data.product\" class=\"form-control\"\n                  placeholder=\"{{'Enter product'  | translate }}\">\n              </div>\n            </div>\n            <!-- <span *ngIf=\"form.inputerror.paymentType != null\" class=\"alertRedColor\" style=\" color: red;\">\n              {{'paymentType'| translate}} </span> -->\n            <span class=\"alertRedColor\" style=\" color: red;\"> {{form.inputerror.product}} </span> \n          </div>\n\n         \n\n          \n          \n\n         \n         \n          <div class=\"row pt-3 pl-3 pb-3\">\n            <div class=\"pt-2\">\n              <button *ngIf=\"!form.data.id>0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\n                {{'Save' | translate }}</button>\n            </div>\n            <div class=\"pt-2\">\n              <button *ngIf=\"form.data.id>0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\n                {{'Update' | translate }}</button>\n            </div>\n            <div class=\"pt-2\">\n              <button (click)=\"forward('/inventorylist')\" type=\"button\"\n                class=\"btn btn-warning mr-1\">{{'List' | translate }}\n              </button>\n            </div>\n          </div>\n\n\n\n        </form>\n      </div>\n    </div>\n  </div>\n</div>  \n<app-footer></app-footer>"
...
/***/ "./src/app/order/order-list.component.html":
/*!*************************************************!*\
  !*** ./src/app/order/order-list.component.html ***!
  \*************************************************/
/*! no static exports found */
...
var OrderListComponent = /** @class */ (function (_super) {
    ...
    function OrderListComponent(locator, route, httpClient) {
        ...
        _this.isValidProductInput = true;
        _this.isValidQuantityInput = true;
        return _this;
    }
    ...
    OrderListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./order-list.component.html */ "./src/app/order/order-list.component.html"),
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_locator_service__WEBPACK_IMPORTED_MODULE_2__["ServiceLocatorService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"]])
    ], OrderListComponent);
...
module.exports = "<app-navbar></app-navbar>\n<style>\n  .grad {\n    background-image: linear-gradient(to bottom right, rgb(32, 168, 168), rgb(219, 231, 237));\n    background-repeat: no repeat;\n    background-size: 100%;\n    padding-bottom: 25px;\n  }\n</style>\n\n<style type=\"text/css\">\n  .log1 {\n    padding-top: 13%;\n  }\n\n  .input-group-addon {\n    box-shadow: 9px 8px 7px #001a33;\n\n  }\n</style>\n\n<div class=\"row \" style=\"padding-top: 2%; padding-bottom:2%;\n\nbackground: url(assets/files/wall.jpg) no-repeat center center;\nbackground-attachment: fixed;\nbackground-size: cover;width:100%;\n  height: auto;\">\n\n  <div class=\"col-sm-4\"></div>\n  <div class=\"col-sm-4\">\n    <div class=\"card\">\n      <div class=\"card-body input-group-addon grad \">\n        <form name=\"userForm\">\n          <h2 *ngIf=\"!form.data.id>0\" class=\"text-primary font-weight-bold\" style=\"text-align: center;\">{{'Add Order' |\n            translate }}</h2>\n          <h2 *ngIf=\"form.data.id>0\" class=\"text-primary font-weight-bold\" style=\"text-align: center;\">{{'Update Order'\n            |\n            translate }}</h2>\n\n\n          <div *ngIf=\"!form.error && form.message != null\" class=\"alert alert-success alert-dismissible\">\n            <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\n            {{form.message}}\n          </div>\n\n          <div *ngIf=\"form.error && form.message != null\" class=\"alert alert-danger alert-dismissible\">\n            <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\n            {{form.message}}\n          </div>\n\n\n          <div>\n            <span class=\"pt-2\"><b>{{'Quantity' | translate }}</b>\n              <span class=\"required-field\"></span></span>\n\n            <div class=\"col-sm-12\">\n              <div class=\"input-group\">\n                <div class=\"input-group-prepend\">\n                  <div class=\"input-group-text\"><i class=\"fa fa-envelope grey-text\"></i> </div>\n                </div>\n                <input type=\"text\" name=\"quantity\" [(ngModel)]=\"form.data.quantity\" class=\"form-control\"\n                  placeholder=\"{{'Enter Quantity'  | translate }}\">\n              </div>\n            </div>\n            <!-- <span *ngIf=\"form.inputerror.branch!= null\" class=\"alertRedColor\" style=\" color: red;\"> {{'branch'|\n              translate}} </span> -->\n            <span class=\"alertRedColor\" style=\" color: red;\"> {{form.inputerror.quantity}} </span>\n          </div>\n\n          <div>\n            <span class=\"pt-2\"><b>{{'Product' | translate }}</b>\n              <span class=\"required-field\"></span></span>\n\n            <div class=\"col-sm-12\">\n              <div class=\"input-group\">\n                <div class=\"input-group-prepend\">\n                  <div class=\"input-group-text\"><i class=\"fa fa-key grey-text\"></i> </div>\n                </div>\n                <input type=\"text\" name=\"product\" [(ngModel)]=\"form.data.product\" class=\"form-control\"\n                  placeholder=\"{{'Enter product'  | translate }}\">\n              </div>\n            </div>\n            <!-- <span *ngIf=\"form.inputerror.paymentType != null\" class=\"alertRedColor\" style=\" color: red;\">\n              {{'paymentType'| translate}} </span> -->\n            <span class=\"alertRedColor\" style=\" color: red;\"> {{form.inputerror.product}} </span>\n          </div>\n\n\n\n          <div>\n\n            <span class=\"pt-2\"><b>{{'DOB' | translate }}</b>\n              <span class=\"required-field\"></span></span>\n\n            <div class=\"col-sm-12\">\n              <div class=\"input-group\">\n                <div class=\"input-group-prepend\">\n                  <div class=\"input-group-text\"><i class=\"fa fa-table grey-text\"></i> </div>\n                </div>\n                <input type=\"date\" name=\"dob\" [value]=\"form.data.dob | date:'yyyy-MM-dd'\"\n                  (input)=\"form.data.dob=parseDate($event.target.value)\" class=\"form-control form-control-sm\"\n                  required />\n              </div>\n            </div>\n            <span *ngIf=\"form.inputerror.dob != null\" class=\"alertRedColor\" style=\" color: red;\"> {{'dob'|\n              translate}} </span>\n            <!-- <span class=\"alertRedColor\"> {{form.inputerror.dob}} </span> -->\n          </div>\n\n\n          <div>\n            <span class=\"pt-2\"><b>{{'Ammount' | translate }}</b>\n              <span class=\"required-field\"></span></span>\n\n            <div class=\"col-sm-12\">\n              <div class=\"input-group\">\n                <div class=\"input-group-prepend\">\n                  <div class=\"input-group-text\"><i class=\"fa fa-key grey-text\"></i> </div>\n                </div>\n                <input type=\"text\" name=\"ammount\" [(ngModel)]=\"form.data.ammount\" class=\"form-control\"\n                  placeholder=\"{{'Enter ammount'  | translate }}\">\n              </div>\n            </div>\n            <!-- <span *ngIf=\"form.inputerror.paymentType != null\" class=\"alertRedColor\" style=\" color: red;\">\n              {{'paymentType'| translate}} </span> -->\n            <span class=\"alertRedColor\" style=\" color: red;\"> {{form.inputerror.ammount}} </span>\n          </div>\n\n\n\n          <div class=\"row pt-3 pl-3 pb-3\">\n            <div class=\"pt-2\">\n              <button *ngIf=\"!form.data.id>0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\n                {{'Save' | translate }}</button>\n            </div>\n            <div class=\"pt-2\">\n              <button *ngIf=\"form.data.id>0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\n                {{'Update' | translate }}</button>\n            </div>\n            <div class=\"pt-2\">\n              <button (click)=\"forward('/orderlist')\" type=\"button\" class=\"btn btn-warning mr-1\">{{'List' | translate }}\n              </button>\n            </div>\n          </div>\n\n\n\n        </form>\n      </div>\n    </div>\n  </div>\n</div>\n<app-footer></app-footer>"
...
/***/ "./src/app/payment/payment-list.component.html":
/*!*****************************************************!*\
  !*** ./src/app/payment/payment-list.component.html ***!
  \*****************************************************/
/*! no static exports found */
...
/***/ "./src/app/payment/payment-list.component.ts":
/*!***************************************************!*\
  !*** ./src/app/payment/payment-list.component.ts ***!
  \***************************************************/
...
var PaymentListComponent = /** @class */ (function (_super) {
    ...
    function PaymentListComponent(locator, route, httpClient) {
        ...
        _this.isValidAccountHolderNameInput = true;
        return _this;
    }
    PaymentListComponent.prototype.validateInput = function (event, field) {
        var value = event.target.value;
        switch (field) {
    ...
    PaymentListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./payment-list.component.html */ "./src/app/payment/payment-list.component.html")
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_locator_service__WEBPACK_IMPORTED_MODULE_3__["ServiceLocatorService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClient"]])
...
module.exports = "<app-navbar></app-navbar>\n<style>\n  .grad {\n    background-image: linear-gradient(to bottom right, rgb(32, 168, 168), rgb(219, 231, 237));\n    background-repeat: no repeat;\n    background-size: 100%;\n    padding-bottom: 25px;\n  }\n</style>\n\n<style type=\"text/css\">\n  .log1 {\n    padding-top: 13%;\n  }\n\n  .input-group-addon {\n    box-shadow: 9px 8px 7px #001a33;\n\n  }\n</style>\n\n<div class=\"row \" style=\"padding-top: 2%; padding-bottom:2%;\n\nbackground: url(assets/files/wall.jpg) no-repeat center center;\nbackground-attachment: fixed;\nbackground-size: cover;width:100%;\n  height: auto;\">\n\n  <div class=\"col-sm-4\"></div>\n  <div class=\"col-sm-4\">\n    <div class=\"card\">\n      <div class=\"card-body input-group-addon grad \">\n        <form name=\"userForm\">\n          <h2 *ngIf=\"!form.data.id>0\" class=\"text-primary font-weight-bold\" style=\"text-align: center;\">{{'Add Payment' |\n            translate }}</h2>\n          <h2 *ngIf=\"form.data.id>0\" class=\"text-primary font-weight-bold\" style=\"text-align: center;\">{{'Update Payment' |\n            translate }}</h2>\n\n\n          <div *ngIf=\"!form.error && form.message != null\" class=\"alert alert-success alert-dismissible\">\n            <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\n            {{form.message}}\n          </div>\n\n          <div *ngIf=\"form.error && form.message != null\" class=\"alert alert-danger alert-dismissible\">\n            <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\n            {{form.message}}\n          </div>\n\n          \n        <div>\n            <span class=\"pt-2\"><b>{{'Account Holder Name' | translate }}</b>\n              <span class=\"required-field\"></span></span>\n            <div class=\"col-sm-12\">\n              <div class=\"input-group\">\n                <div class=\"input-group-prepend\">\n                  <div class=\"input-group-text\"><i class=\"fa fa-user-circle grey-text\"></i> </div>\n                </div>\n                <input type=\"text\" name=\"accountHolderName\" [(ngModel)]=\"form.data.accountHolderName\" class=\"form-control\"\n                  placeholder=\"{{'Enter Account Holder Name'  | translate }}\">\n              </div>\n           </div>\n           <!-- <span *ngIf=\"form.inputerror.accountholdername != null\" class=\"alertRedColor\" style=\" color: red;\">\n              {{'accountholdername'| translate}} </span>  -->\n            <span class=\"alertRedColor\" style=\"color: red;\"> {{form.inputerror.accountHolderName}} </span>\n          </div>\n\n          <div>\n            <span class=\"pt-2\"><b>{{'Account No' | translate }}</b>\n              <span class=\"required-field\"></span></span>\n\n            <div class=\"col-sm-12\">\n              <div class=\"input-group\">\n                <div class=\"input-group-prepend\">\n                  <div class=\"input-group-text\"><i class=\"fa fa-user grey-text\"></i> </div>\n                </div>\n                <input type=\"text\" name=\"accountNo\" [(ngModel)]=\"form.data.accountNo\" class=\"form-control\"\n                  placeholder=\"{{'Enter Account No'  | translate }}\">\n              </div>\n            </div>\n            <!-- <span *ngIf=\"form.inputerror.accountNo != null\" class=\"alertRedColor\" style=\" color: red;\">\n              {{'accountNo'| translate}} </span> -->\n           <span class=\"alertRedColor\" style=\" color: red;\"> {{form.inputerror.accountNo}} </span>\n          </div>\n\n          <div>\n            <span class=\"pt-2\"><b>{{'Branch' | translate }}</b>\n              <span class=\"required-field\"></span></span>\n\n            <div class=\"col-sm-12\">\n              <div class=\"input-group\">\n                <div class=\"input-group-prepend\">\n                  <div class=\"input-group-text\"><i class=\"fa fa-envelope grey-text\"></i> </div>\n                </div>\n                <input type=\"text\" name=\"branch\" [(ngModel)]=\"form.data.branch\" class=\"form-control\"\n                  placeholder=\"{{'Enter Branch'  | translate }}\">\n              </div>\n            </div>\n            <!-- <span *ngIf=\"form.inputerror.branch!= null\" class=\"alertRedColor\" style=\" color: red;\"> {{'branch'|\n              translate}} </span> -->\n             <span class=\"alertRedColor\" style=\" color: red;\"> {{form.inputerror.branch}} </span> \n          </div>\n\n          <div>\n            <span class=\"pt-2\"><b>{{'Payment Type' | translate }}</b>\n              <span class=\"required-field\"></span></span>\n\n            <div class=\"col-sm-12\">\n              <div class=\"input-group\">\n                <div class=\"input-group-prepend\">\n                  <div class=\"input-group-text\"><i class=\"fa fa-key grey-text\"></i> </div>\n                </div>\n                <input type=\"text\" name=\"paymentType\" [(ngModel)]=\"form.data.paymentType\" class=\"form-control\"\n                  placeholder=\"{{'Enter Payment Type'  | translate }}\">\n              </div>\n            </div>\n            <!-- <span *ngIf=\"form.inputerror.paymentType != null\" class=\"alertRedColor\" style=\" color: red;\">\n              {{'paymentType'| translate}} </span> -->\n            <span class=\"alertRedColor\" style=\" color: red;\"> {{form.inputerror.paymentType}} </span> \n          </div>\n\n          <div>\n            <span class=\"pt-2\"><b>{{'Payment Date' | translate }}</b>\n              <span class=\"required-field\"></span></span>\n\n            <div class=\"col-sm-12\">\n              <div class=\"input-group\">\n                <div class=\"input-group-prepend\">\n                  <div class=\"input-group-text\"><i class=\"fa fa-phone grey-text\"></i> </div>\n                </div>\n                <input type=\"date\" name=\"paymentDate\" maxlength=\"10\" [(ngModel)]=\"form.data.paymentDate\" class=\"form-control\"\n                  placeholder=\"{{'Enter Payment Date' | translate}}\">\n              </div>\n            </div>\n            <!-- <span *ngIf=\"form.inputerror.paymentDate != null\" class=\"alertRedColor\" style=\" color: red;\"> {{'paymentDate'|\n              translate}} </span> -->\n            <span class=\"alertRedColor\" style=\" color: red;\"> {{form.inputerror.paymentDate}} </span> \n          </div>\n\n          \n          <div>\n            <span class=\"pt-2\"><b>{{'Gender' | translate }}</b>\n              <span class=\"required-field\"></span></span>\n\n            <div class=\"col-sm-12\">\n              <div class=\"input-group\">\n                <div class=\"input-group-prepend\">\n                  <div class=\"input-group-text\"><i class=\"fa fa-venus grey-text\"></i> </div>\n                </div>\n                <select class=\"form-control\" name=\"gender\" id=\"gender\" [(ngModel)]=\"form.data.gender\"\n                  style=\"cursor: pointer;\">\n                  <option [ngValue]=\"\" value=\"undefined\">{{'Please select' | translate }}</option>\n                  <option value=\"Male\">{{'Male' | translate }} </option>\n                  <option value=\"Female\">{{'Female' | translate }} </option>\n                </select>\n              </div>\n            </div>\n            <!-- <span *ngIf=\"form.inputerror.gender != null\" class=\"alertRedColor\" style=\" color: red;\"> {{form.inputerror.gender}} </span> -->\n             <span class=\"alertRedColor\" style=\" color: red;\" > {{form.inputerror.gender}} </span> \n          </div>\n\n         \n         \n          <div class=\"row pt-3 pl-3 pb-3\">\n            <div class=\"pt-2\">\n              <button *ngIf=\"!form.data.id>0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\n                {{'Save' | translate }}</button>\n            </div>\n            <div class=\"pt-2\">\n              <button *ngIf=\"form.data.id>0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\n                {{'Update' | translate }}</button>\n            </div>\n            <div class=\"pt-2\">\n              <button (click)=\"forward('/paymentlist')\" type=\"button\"\n                class=\"btn btn-warning mr-1\">{{'List' | translate }}\n              </button>\n            </div>\n          </div>\n\n\n\n        </form>\n      </div>\n    </div>\n  </div>\n</div>  \n<app-footer></app-footer>"
...
var UserComponent = /** @class */ (function (_super) {
    ...
    UserComponent.prototype.submit = function () {
        ...
        console.log(this.form.data);
        this.serviceLocator.httpService.post(this.api.save, this.form.data, function (res) {
            console.log('id dto>>>>>>>>>>>>>> >>>> ', res.result.data);
            _self.form.message = '';
            _self.form.data.id = res.result.data;
            console.log('id >>>> ', _self.form.data.id);
            if (_self.fileToUpload) {
                console.log('rahul');
                _self.myFile();
            }
            ...
            _self.form.data.id = res.result.data.id;
            console.log('idddddddddddd>>>>>>>>', _self.form.data.id);
        });
    };
...
module.exports = __webpack_require__(/*! C:\Rays Soft\Workspace\project10FrontCtl\proect10_FrontCtl-main\ORSProject10-UIFctl\src\main.ts */"./src/main.ts");
